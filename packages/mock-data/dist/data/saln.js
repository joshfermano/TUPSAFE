...
export const mockSalnSubmissions = [
    {
...
export const mockSalnRealProperties = [
...
export const mockSalnPersonalProperties = [
...
export const mockSalnLiabilities = [
...
export const mockSalnBusinessInterests = [
    {
...
export const mockSalnRelativesInGov = [
    {
...
export function generateMockSalnSubmission(userId, year, status = 'draft', filingType = 'separate') {
...
export function generateMockRealProperty(salnSubmissionId, description, kind, location, acquisitionYear) {
...
export const filipinoSurnames = [
    "dela Cruz", "Santos", "Reyes", "Garcia", "Gonzales", "Rodriguez", "Hernandez",
    "Martinez", "Lopez", "Perez", "Ramos", "Flores", "Rivera", "Torres", "Ramirez",
    "Cruz", "Morales", "Gutierrez", "Ortiz", "Vargas", "Castro", "Romero", "Jimenez",
    "Herrera", "Medina", "Aguilar", "Guerrero", "Vega", "Soto", "Mendoza", "Salazar",
    "Bautista", "Aquino", "Fernandez", "Villanueva", "Rosario", "Mercado", "Castillo",
    "Pascual", "Navarro", "Campos", "Cabrera", "Valdez", "Alvarez", "Diaz", "Moreno"
];
// Common Filipino given names
export const filipinoGivenNames = {
    male: [
        "Juan", "Jose", "Antonio", "Manuel", "Francisco", "Pedro", "Carlos", "Miguel",
        "Rafael", "Fernando", "Roberto", "Ricardo", "Eduardo", "Luis", "Alejandro",
        "Diego", "Andres", "Felipe", "Joaquin", "Emilio", "Vicente", "Sergio", "Alberto",
        "Mario", "Jorge", "Raul", "Arturo", "Oscar", "Victor", "Cesar", "Ernesto"
    ],
    female: [
        "Maria", "Ana", "Carmen", "Rosa", "Elena", "Isabel", "Teresa", "Patricia",
        "Luz", "Gloria", "Esperanza", "Concepcion", "Dolores", "Francisca", "Remedios",
        "Josefa", "Soledad", "Pilar", "Mercedes", "Cristina", "Beatriz", "Margarita",
        "Victoria", "Amparo", "Corazon", "Milagros", "Socorro", "Paz", "Fe", "Caridad"
    ]
};
// Export summary
