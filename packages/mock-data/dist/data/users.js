...
export function getProfilesByDepartment(departmentId) {
...
export function getDepartmentsByParent(parentId) {
...
export function generateMockProfile(firstName, lastName, middleName, role, departmentId, positionId) {
...
export function generateMockDepartment(name, code, parentId = null) {
    return {
        id: uuidv7(),
        name,
        code,
...
export function generateMockPosition(title, gradeLevel, departmentId) {
    return {
        id: uuidv7(),
        title,
        gradeLevel,
