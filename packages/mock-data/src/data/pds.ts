...
export const mockPdsSubmissions: PdsSubmission[] = [
  {
...
export const mockPdsPersonalInfo: PdsPersonalInfo[] = [
  {
...
export const mockPdsFamilyBackground: PdsFamilyBackground[] = [
  {
...
// Mock PDS Children
export const mockPdsChildren: PdsChildren[] = [
  {
...
// Mock PDS Education
export const mockPdsEducation: PdsEducation[] = [
...
export const mockPdsCivilService: PdsCivilService[] = [
  {
...
export const mockPdsWorkExperience: PdsWorkExperience[] = [
...
export const mockPdsVoluntaryWork: PdsVoluntaryWork[] = [
  {
...
// Mock PDS Training
export const mockPdsTraining: PdsTraining[] = [
  {
...
export const mockPdsOtherInfo: PdsOtherInfo[] = [
  {
...
// Helper functions
export function getPdsSubmissionById(id: string): PdsSubmission | undefined {
  return mockPdsSubmissions.find((pds) => pds.id === id);
}

export function getPdsSubmissionsByUserId(userId: string): PdsSubmission[] {
  return mockPdsSubmissions.filter((pds) => pds.userId === userId);
}

export function getPdsPersonalInfoBySubmissionId(
  submissionId: string
): PdsPersonalInfo | undefined {
  return mockPdsPersonalInfo.find(
    (info) => info.pdsSubmissionId === submissionId
  );
}

export function getPdsFamilyBackgroundBySubmissionId(
  submissionId: string
): PdsFamilyBackground | undefined {
  return mockPdsFamilyBackground.find(
    (family) => family.pdsSubmissionId === submissionId
  );
}

export function getPdsChildrenBySubmissionId(
  submissionId: string
): PdsChildren[] {
  return mockPdsChildren.filter(
    (child) => child.pdsSubmissionId === submissionId
  );
}

export function getPdsEducationBySubmissionId(
  submissionId: string
): PdsEducation[] {
  return mockPdsEducation.filter((edu) => edu.pdsSubmissionId === submissionId);
}

export function getPdsCivilServiceBySubmissionId(
  submissionId: string
): PdsCivilService[] {
  return mockPdsCivilService.filter(
    (cs) => cs.pdsSubmissionId === submissionId
  );
}

export function getPdsWorkExperienceBySubmissionId(
  submissionId: string
): PdsWorkExperience[] {
  return mockPdsWorkExperience.filter(
    (work) => work.pdsSubmissionId === submissionId
  );
}

export function getPdsVoluntaryWorkBySubmissionId(
  submissionId: string
): PdsVoluntaryWork[] {
  return mockPdsVoluntaryWork.filter(
    (vol) => vol.pdsSubmissionId === submissionId
  );
}

export function getPdsTrainingBySubmissionId(
  submissionId: string
): PdsTraining[] {
  return mockPdsTraining.filter(
    (training) => training.pdsSubmissionId === submissionId
  );
}

export function getPdsOtherInfoBySubmissionId(
  submissionId: string
): PdsOtherInfo | undefined {
  return mockPdsOtherInfo.find((info) => info.pdsSubmissionId === submissionId);
}

export function getCompletePdsSubmission(submissionId: string) {
