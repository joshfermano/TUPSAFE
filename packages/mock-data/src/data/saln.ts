...
export const mockSalnSubmissions: SalnSubmission[] = [
  {
    ...
    agency: 'College of Engineering',
    officeAddress: 'TUP Manila, Ayala Blvd, Ermita',
  ...
  },
  {
    ...
    year: 2024,
    status: 'submitted',
    spouseName: 'Maria Santos',
    position: 'Associate Professor',
    agency: 'College of Science',
    officeAddress: 'TUP Manila, Ayala Blvd, Ermita',
  ...
  },
  {
    ...
    agency: 'College of Industrial Technology',
    officeAddress: 'TUP Manila, Ayala Blvd, Ermita',
  ...
  },
  {
    ...
    agency: 'College of Liberal Arts',
    officeAddress: 'TUP Manila, Ayala Blvd, Ermita',
  ...
  },
  {
    ...
    agency: 'College of Architecture and Fine Arts',
    officeAddress: 'TUP Manila, Ayala Blvd, Ermita',
...
export function generateMockSalnSubmission(
  ...
  return {
    ...
    year,
    status,
    spouseName: filingType === 'joint' ? 'Generated Spouse Name' : null,
