import { boolean, date, decimal, inet, integer, jsonb, pgEnum, pgTable, text, timestamp, uuid, } from 'drizzle-orm/pg-core';
...
export const pdsSubmissionsRelations = relations(pdsSubmissions, ({ one, many }) => ({
    user: one(profiles, {
...
export const salnSubmissionsRelations = relations(salnSubmissions, ({ one, many }) => ({
    user: one(profiles, {
