  ...
  useEffect(() => {
    if (position) {
      form.reset({
        ...
        salaryRangeMin: position.salaryRangeMin ? parseFloat(position.salaryRangeMin) : undefined,
        salaryRangeMax: position.salaryRangeMax ? parseFloat(position.salaryRangeMax) : undefined,
