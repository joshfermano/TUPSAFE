...
export class MockAuth {
  ...
  static async signIn(email: string, password: string): Promise<{ user: MockUser; session: MockSession } | null> {
  ...
  static async updateUser(id: string, updates: Partial<Omit<MockUser, 'id' | 'createdAt'>>): Promise<MockUser | null> {
